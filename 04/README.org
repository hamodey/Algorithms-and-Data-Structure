...
#+SUBTITLE: week of 23rd October 2017
...
** More derived methods
   You might wish to work through the [[http://www.doc.gold.ac.uk/~mas01cr/teaching/is52038b/2017-18/ListAlgorithms.html][interactive exercise]] related to
   recursively-expressed algorithms on linked lists, available from
   the [[https://learn.gold.ac.uk/course/view.php?id=6822][module VLE page]].
** Submission
   There will be a submission related to this lab in one week
   (deadline *16:00 3rd November 2017*); you will be asked to submit
