...
#+SUBTITLE: week of 9th October 2017

#+include: ../labsheet.org

This week's lab includes an assessment, available from the module
[[https://learn.gold.ac.uk/course/view.php?id=6822][learn.gold page]], which is open only during the lab session.  Be sure
to [[https://learn.gold.ac.uk/mod/lti/view.php?id=487683][submit]] before the end of the session!
...
#+end_example
   ...
   ~is52038-labs~ under your current working directory.
#+BEGIN_EXPORT LaTeX
\clearpage
#+END_EXPORT
...
* Uploading your work
  ...
  [[https://learn.gold.ac.uk/mod/lti/view.php?id=487683][online submission system]].  Access to the online submission will be
  closed after the end of the lab.  You may submit more than once, and
  your best score will be kept: do not wait until the very end of the
  session.
